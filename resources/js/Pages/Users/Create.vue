                                            ...
                                            <fieldset class="space-y-5">
                                                ...
                                                <div class="relative flex items-start" v-for="(name, id) in roles" :key="id">
                                                    <div class="flex h-5 items-center">
                                                        <input :id="'role-' + id" v-model="selectedRoles" aria-describedby="role-description" type="checkbox" :value="name" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    </div>

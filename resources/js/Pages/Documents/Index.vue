                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="sm:flex-auto pt-5">
                            <h1 class="text-xl font-semibold text-gray-900">List Documents</h1>
                        ...
                        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            ...
                            <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8">{{ document.id }}</td>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <Link :href="'/documents/' + document.id" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto mr-1">show</Link>

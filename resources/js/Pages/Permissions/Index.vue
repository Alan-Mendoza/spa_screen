                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                            <Link href="/permissions/create" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add Permission</Link>
                        </div>
                        </div>
                            ...
                            <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        ...
                                        <button @click="deletePermission(permission.id)" class="inline-flex items-center justify-center rounded-md border border-transparent bg-red-400 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Delete</button>
                                    </td>
                                    </tr>
                                </tbody>
                                </table>

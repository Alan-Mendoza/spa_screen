...
const originalName = props.permission.name;
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="mt-10 sm:mt-0">
                        ...
                        <div class="md:col-span-1 pt-5 pl-5">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Enter the necessary information here to update the permission name.</p>
                            </div>
                        </div>
                        <div class="mt-5 md:col-span-2 md:mt-0">
                            ...
                            <div class="overflow-hidden shadow sm:rounded-md">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <label for="name" class="block text-sm font-medium text-gray-700">Name Permission</label>
